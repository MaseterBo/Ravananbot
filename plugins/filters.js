...
const array = ['name entha','King','Kooi','Love','Thamasha','big fan','charlie','gd n8','kar98','love u','noob','Poweresh','niyas paranki','perfect ok','power','saji','single','uyir','thug','avastha','Moodesh','sketched','Cr7','Cr7 back','Suiii','Portugal','Haters','ayn']
array.map( async (a) => {
